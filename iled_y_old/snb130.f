...
C     COMPARE 3 DIFFERENT Rmin TARGET FUNCTIONS, SAVE PHASE SETS
      parameter (mp=9000,mt=200000,mp2=18001,mt3=3*mt,mx=32768)
      character fil*6
      ...
      dimension cs(-mx:mx),sn(-mx:mx),xx(1500,3)
