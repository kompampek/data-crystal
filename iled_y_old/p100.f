C     PROGRAM = P10 formula
      ...
      dimension e(0:IE),p(-IE:IE),sct(8)
   ...
   30 format(8i5)
      ...
      Z3=0. 
      DO 31 I = 1,8
      Z2 = Z2 + (2-ICENT)*NSYM*NA(I)*SCT(I)**2
   31 Z3 = Z3 + (2-ICENT)*NSYM*NA(I)*SCT(I)**3
      ROUTN = (Z2**1.5)/Z3
      EN=ROUTN**2
      write(*,*)en
      do 1 i=1,NSYM
   ...
   19 if(enn.ge.EBIG) LIM1=I
    ...
    5 nl=min(il,nl)
      ...
      write(*,23)NREF,LIM1,EBIG
   23 format(i5,' Es,',i5,' Es >',f5.2)  
      IHR=MH+1
      IKR=MK-NK+1
      nref2=nref/2
      do 7 I=1,NREF
...
C     L-M, IS6
      ...
      as=as+am
      bs=bs+bm
c      if(iq.gt.4) write(42,29)IQ,J,I1,I2,I3,I4,I5,I6
   29 format(8i6)       
   17 CONTINUE
      NC(J)=JNC
   16 CONTINUE
