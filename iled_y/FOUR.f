...
C     CALCULATE Rmin, COSAV, TRIPLES Phase error
  ...
  355 a2=a2+acos(dp)
   ...
   35 CONTINUE   
      ...
      MIT=1
      if(list.ne.0) mit=mod(ncyc,10)*LIST
      if(mit.EQ.0.)write(*,5)iran,ncyc,Rold,Cosav,angle,axe,k1,k2,k3,k4
    5 format(i7,i4,2f7.3,2f6.1,4i3)
      if(ncyc.gt.10.and.angle.lt.75.) goto 789
   21 CONTINUE 
   ...
   10 CONTINUE
      iran=iran+2
      goto 15
  789 write(3,5)iran,kcyc,rold,cosav,angle,axe,k1,k2,k3,k4
      write(13,5)iran,kcyc,rold,cosav,angle,axe,k1,k2,k3,k4
