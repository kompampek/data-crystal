...
C
   ...
   42 j4=i1+k1
      ...
      IF(j4.GT.MAXH.OR.j5.GT.MAXK.OR.j6.GT.MAXL) GOTO 43
      IF(j4.LT.MINH.OR.j5.LT.MINK.OR.j6.LT.MINL) GOTO 43
   ...
   43 k4=k1+j1
      ...
      IF(k4.GT.MAXH.OR.k5.GT.MAXK.OR.k6.GT.MAXL) GOTO 44
      IF(k4.LT.MINH.OR.k5.LT.MINK.OR.k6.LT.MINL) GOTO 44
